...
{
    public class SMA_ReadRepository : ReadRepository<SirketMailAdresi>, ISMA_ReadRepository
    {
        public SMA_ReadRepository(EPostaGonderimAPIDbContext context) : base(context)
        {
        }
    }
}
